...
\author[
  addressref = {aff1},                       % Identifica o autor
  email      = {italo.menezes@ccc.ufcg.edu.br} % email para contato
]
{
  \inits{IMdLP}      % Letras iniciais do autor #3
  \fnm{Italo M. de L.} % Nome do autor #3 (first and middle name)
...
\author[
  addressref = {aff1},                 % Identifica o autor
  email      = {vinicius.lucena@ccc.ufcg.edu.br} % email para contato
]
{
