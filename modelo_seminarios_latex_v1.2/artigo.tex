...
\caption{Resumo dos direitos garantidos pelas licenças de software}
	\begin{tabular}{cccc}
							&	Domínio Público	&	\textit{FOSS}				&	Licença Proprietária
	Direito de cópia		&	Sim				&	Sim							&	Não
	Direito de modificar	&	Sim				&	Sim							&	Não
	Direito de distribuição	&	Sim				&	Sim, sob a mesma licença	&	Não
	\end{tabular}
\end{table}
...
\noindent {\bf Gabriel Silva Vinha} nasceu no Brasil, no estado de São Paulo e na cidade de São Paulo. Atualmente, está na graduação em ciência da computação, pela Universidade Federal de Campina Grande. Atualmente, é desenvolvedor part-time em um projeto da parceria entre o Laboratório de Sitemas Distribuídos, \textit{Software Practices Laboratory}, Lenovo Brasil e \textit{RedHat International}. Tem interesse na área de desenvolvimento web, com foco em aplicações e sistemas em nuvem.
